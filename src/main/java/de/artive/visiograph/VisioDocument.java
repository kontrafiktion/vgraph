...
public class VisioDocument {
  ...
  public static final String VISIOGRAPH_STAMP_EXT_ID = "visiograph-stamp";
  ...
  private void loadDocument(String templateName) throws IOException {
    ...
    Element oldStamp = shapeForExtId(root, VISIOGRAPH_STAMP_EXT_ID);
    if (oldStamp != null) {
    ...
    VisioRectangle newStamp = new VisioRectangle(new BigDecimal("3"),
                                                 ...
                                                 new BigDecimal("5"),
                                                 new BigDecimal("0.5"),
                                                 VISIOGRAPH_STAMP_EXT_ID,
                                                 "generated by visiograph (C) 2010 Victor Volle\n" + new Date());
    addShape(newStamp);
  ...
  private Element shapeForExtId(Element root, String extId) {
    // root.query("/v:VisioDocument/v:Pages/v:Page[@ID='0']/v:Shapes/v:Shape[v:Prop[v:Label='external_id' and v:Value='visiograph-stamp']]", XmlHelper.VISIO_XPATH_CONTEXT)
